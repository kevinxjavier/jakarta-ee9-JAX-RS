...
import com.kevinpina.client.model.Instructor;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        WebTarget rootUri = client.target("http://kevin.cx:8081/jakarta-ee9-jaxrs/api").path("/courses");
        ...
        Course newCourse = Course.builder()
                .name("Cobol")
                .description("Learning Cobol")
                .duration(1D)
                .instructor(Instructor.builder().id(1).name("hans").surName("bullow").build()).build();
